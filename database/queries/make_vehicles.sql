...
CREATE TABLE IF NOT EXISTS vehicles (
    ...
    frames_chasiss_id INT NULL COMMENT 'For JDM, foreign key referencing frames_chasiss table',
    frame_nums_id INT NULL COMMENT 'For JDM, foreign key referencing frame_nums_id table',
    ...
    CONSTRAINT fk_frames_chasiss2 FOREIGN KEY (frames_chasiss_id) REFERENCES frames_chasiss(id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_frame_nums2 FOREIGN KEY (frame_nums_id) REFERENCES frame_nums(id) ON DELETE CASCADE ON UPDATE CASCADE,
